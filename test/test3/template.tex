...
\setCJKsansfont[Path=../../fonts/, BoldFont=SOURCEHANSANSSC-MEDIUM-2.otf]{FANGZHENGHEITI-GBK-1.ttf}
% 中文等宽字体：方正仿宋_GBK
\setCJKmonofont[Path=../../fonts/]{FANGZHENGFANGSONG-GBK-1.ttf}

\newCJKfontfamily\songti{FANGZHENGSHUSONG-GBK-1.ttf}[Path=../../fonts/, BoldFont=SOURCEHANSERIFCN-MEDIUM-6.otf]
\newCJKfontfamily\xbsong{SOURCEHANSERIFCN-MEDIUM-6.otf,}[Path=../../fonts/] % 小标宋
\newCJKfontfamily\dbsong{SOURCEHANSERIFCN-BOLD-2.otf}[Path=../../fonts/] % 大标宋
\newCJKfontfamily\cusong{SOURCEHANSERIFCN-HEAVY-4.otf}[Path=../../fonts/] % 粗宋
\newCJKfontfamily\heiti{FANGZHENGHEITI-GBK-1.ttf}[Path=../../fonts/, BoldFont=SOURCEHANSANSSC-MEDIUM-2.otf]
\newCJKfontfamily\dahei{SOURCEHANSANSSC-MEDIUM-2.otf}[Path=../../fonts/] % 大黑
\newCJKfontfamily\cuhei{SOURCEHANSANSSC-BOLD-2.otf}[Path=../../fonts/] % 粗黑
\newCJKfontfamily\fangsong{FANGZHENGFANGSONG-GBK-1.ttf}[Path=../../fonts/]
\newCJKfontfamily\kaiti{FANGZHENGKAITI-GBK-1.ttf}[Path=../../fonts/]
